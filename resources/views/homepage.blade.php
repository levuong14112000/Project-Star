...
<div id="features-sec" class="container set-pad" data-aos="fade-left" style="transition: 1s linear all">
    <div class="row text-center">
...
<div id="features-sec" class="container set-pad" data-aos="fade-right" style="transition: 1s linear all">
    <div class="row text-center">
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
...
<div id="faculty-sec" data-aos="fade-left" style="transition: 1s linear all">
...
<!-- FACULTY SECTION END-->
<div id="course-sec" class="container set-pad" data-aos="fade-right" style="transition: 1s linear all">
    <div class="row text-center">
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
...
<div id="contact-sec">
    <div class="overlay">
        <div class="container set-pad" data-aos="fade-left" style="transition: 1s linear all">
            <div class="row text-center">
                <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
