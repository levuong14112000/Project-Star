...
class myController extends Controller
{
    public function main()
    {
        ...
        $xuat = DB::table('courses')
            ...
            ->distinct()
            ->select ('courses.course_name', 'subject.subject_name', 'lessions.lession_name', 'courses.price','subject.subject_id')
    ...
    {
        $query = DB::table('subject') //Sử dụng class DB
            ->select("course_id", "subject_name", "content", "picture", "subject_id","course_name")
            ->where('course_id', '=', $id)
            ->orderBy('subject_name', 'ASC')
            ->get();
